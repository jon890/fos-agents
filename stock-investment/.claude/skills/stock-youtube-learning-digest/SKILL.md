...
description: 자산제곱, 월가아재의 과학적 투자 같은 주식 유튜브 채널의 신규 영상을 매일 확인하고, 주식·경제 일반론 학습 가치가 있는 영상만 한국어로 핵심 주장·배울 점·주의점·링크 중심으로 요약해 Discord에 전달하는 stock-investment skill. 신규/유효 영상이 없으면 아무 메시지도 보내지 않는다.
---
...
- 신규 영상이 없거나 학습 가치가 낮으면 **stdout을 비워** 불필요한 외부 알림과 토큰 비용을 아낀다.
- 메시지는 한국어로 핵심 주장, 배울 점, 주의점, 링크를 포함한다.
