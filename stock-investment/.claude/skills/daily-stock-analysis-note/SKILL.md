...
description: 미국·한국 AI/기술주 한 종목을 한국어 블로그형 분석 노트 초안으로 작성하는 stock-investment skill. "오늘 종목 분석 노트 써줘", "NVDA 블로그 노트 작성해줘", "일일 분석 노트 돌려줘", `/daily-stock-analysis-note`, cron 09:00 Asia/Seoul처럼 내러티브, 실적, 전망, 리스크, 체크포인트가 포함된 종목 분석 노트가 필요할 때 사용. 매수·매도 조언을 하지 않고 관찰 후보 / 분석 후보로 프레임한다.
---
