...
관련 pattern은 `../plan-and-build/references/common-pitfalls/harness/6-8-cwd-workspace-mismatch.md`를 참조한다.
...
관련 pattern은 `../plan-and-build/references/common-pitfalls/harness/6-9-sigil-self-positive.md`를 참조한다.
...
- SKILL.md 전면 재작성: 6-6, 6-7.
- repo root 기준 path가 있는 bash 검증: 6-8.
- 검증 대상 sigil 문자가 있는 문서 작업: 6-9.
