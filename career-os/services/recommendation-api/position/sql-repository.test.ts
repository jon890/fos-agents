    ...
    company_tier_assessments: [
      {
        ...
        evidence_json: [
          { url: "https://example.com/company/2", checkedAt: "2026-09-17", validUntil: "2026-12-17" },
        ],
  ...
  const ranking = [
    {
      ...
      companyTier: 1,
      companyTierSource: "manual" as const,
    ...
    },
    {
      ...
      companyTierAssessedAt: "2026-09-17T00:20:00.000Z",
      companyTierValidUntil: "2026-12-16",
      companyTierConfidence: "medium" as const,
      companyTierReason: "성장 범위를 확인했다.",
      companyTierEvidenceUrls: ["https://example.com/company/2"],
