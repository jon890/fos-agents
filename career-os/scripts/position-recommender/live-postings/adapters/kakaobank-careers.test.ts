...
const notice = {
  recruitNoticeSn: 257562,
  recruitNoticeName: "신용리스크 시스템 개발자",
  recruitClassName: "Core Banking",
  receiveStartDatetime: "2026-06-19 00:00:00",
  receiveEndDatetime: "2026-07-10 23:59:59",
};
...
test("계약직 공고는 수집하지 않는다", () => {
  expect(
    parseKakaoBankPosting({ ...notice, recruitNoticeName: "시스템 개발자 (계약직)" }, detailHtml),
  ).toBeNull();
});
