...
const PositionEntrySchema = z.object({
  ...
  activeEvidence: z.string().optional(),
  ...
  for (const pos of positions) {
    ...
    try {
      record = ApplicationLedgerRecordSchema.parse({
        ...
        source: pos.source,
        url: pos.url,
        discoveryMode: pos.discoveryMode,
        activeEvidence: pos.activeEvidence,
        identityHash: pos.identityHash,
        careerUpsideHypothesis: pos.careerUpsideHypothesis,
        careerUpsideEvidence: pos.careerUpsideEvidence,
        careerUpsideRiskFlags: pos.careerUpsideRiskFlags,
        status: 'discovered',
        statusUpdatedAt: now,
        discoveredAt: now,
        ...
        revisionCount: 0,
        maxRevisionCount: 3,
        riskFlags: pos.careerUpsideRiskFlags ?? [],
