...
export const ApplicationPositionsQueueRecordSchema = z
  .object({
    ...
    candidateInterviewPath: z.string().min(1).optional(),
    fitAnalysisPath: z.string().min(1).optional(),
    applicationPackagePath: z.string().min(1).optional(),
    applicationPackageHtmlPath: z.string().min(1).optional(),
    resumeDraftPath: z.string().min(1).optional(),
    resumeDesignPath: z.string().min(1).optional(),
    resumeHtmlPath: z.string().min(1).optional(),
    resumePdfPath: z.string().min(1).optional(),
    coverLetterPath: z.string().min(1).optional(),
    submissionChecklistPath: z.string().min(1).optional(),
