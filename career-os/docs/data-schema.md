...
| `data/prep/` | 회사/면접 단계별 hand-crafted 준비 자산. 새 active 준비는 position home의 `interview/prep.md`를 우선한다 | ✓ |
...
### data/prep/<company-or-stage-slug>/

회사/면접 단계별 hand-crafted 준비 자산.
