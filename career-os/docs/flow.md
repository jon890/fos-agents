...
4. 소유권과 수치의 범위를 판정해 근거 장부를 만든다.
5. 근거가 약한 문장은 삭제하거나 확인 가능한 표현으로 낮춘다.
6. evaluator가 내용, 가독성, 채용 공고 적합도, HTML 품질을 채점한다.
7. 정적 검사와 실제 브라우저 렌더링으로 페이지 수와 잘림을 확인한다.
8. 보이는 문구가 바뀌면 근거 감사를 다시 실행한다.
