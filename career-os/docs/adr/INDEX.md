...
| ADR-004 | reports/ 디렉터리 컨벤션 [폐기] | 폐기 (superseded 2026-04-18 by no-action) | [ADR-004-reports-디렉터리-컨벤션-폐기.md](ADR-004-reports-디렉터리-컨벤션-폐기.md) |
...
| ADR-007 | Experience-based interview question bank workflow | Superseded by [[ADR-027]] (plan015, 2026-05-15) — Q&A workflow가 interview-asset-writer로 통합. 별도 experience-question-bank-writer 스킬 폐기. | [ADR-007-experience-based-interview-question-bank-workflow.md](ADR-007-experience-based-interview-question-bank-workflow.md) |
...
| ADR-029 | cj-foodville-coffeechat-prep → interview-coffeechat-prep native rename + 회사 추상화 + ts collector + 준비 자산 data 이동 |  | [ADR-029-cj-foodville-coffeechat-prep-interview-coffeechat-prep-native-rename-회사-추상화-ts-collector-준비-자산-data-이동.md](ADR-029-cj-foodville-coffeechat-prep-interview-coffeechat-prep-native-rename-회사-추상화-ts-collector-준비-자산-data-이동.md) |
...
| ADR-076 | plan048 tracked runtime exception을 제거한다 | Accepted | [ADR-076-plan048-tracked-runtime-exception을-제거한다.md](ADR-076-plan048-tracked-runtime-exception을-제거한다.md) |
