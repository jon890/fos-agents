## ADR-074 position source coverage는 official adapter와 Wanted discovery를 함께 쓴다
...
- Coupang처럼 공식 detail/listing HTML이 fetch에서 차단되는 회사도 접근 가능한 공식 sitemap을 우선 사용한다.
...
- 선호 회사군 공고가 Wanted 최신순 broad scan 뒤에 묻히는 문제를 공식 adapter로 줄인다.
