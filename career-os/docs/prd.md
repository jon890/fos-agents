...
첫 화면에는 현재 할 일, 제출 후보 PDF와 필요한 경우의 지원서 입력값을 보여준다.
지원 전략은 승부처, 지원동기, 공백과 다음 행동만 펼쳐 보여주며 이력서 원문과 내부 검증 자료는 닫힌 상세 영역에서 확인한다.
...
- Career OS 전용 웹 제품이나 관계형 데이터베이스를 필수 운영 요소로 두지 않는다.
