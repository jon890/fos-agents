...
- 공개 가능한 HTML은 사용자 승인 후 공유 주소로 게시해 여러 기기에서 다시 볼 수 있게 한다.
...
- 현재 자산: `state/mvp-target.json`, positions-queue (옛 ledger), job-fit report, drill log, private question bank.
