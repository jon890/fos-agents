...
| `/candidate-baseline-suggester` | ⚠️ 제거 예정 (plan086 phase-06 이후)<br>fos-study 학습 이력 기반 자산 자동 갱신<br>audit trail: `data/runtime/profile-refresh-suggestions/YYYY-MM-DD/`<br>ADR-028, plan020 | 없음 | 제거 예정 |
