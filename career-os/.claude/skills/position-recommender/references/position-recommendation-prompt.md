...
## 최근 반복 점검
- 최근 7일 반복 추천 후보가 있으면 active/open 상태와 유지 사유를 쓴다.
- 반복 자체는 감점 사유가 아니다. 닫히지 않았고 아직 지원하지 않았으며 fit이 높다면 계속 상위 후보로 둔다.
- 신규 active 공고가 상위 후보에 들어갔다면 왜 기존 반복 후보보다 나은지 쓴다.
- 신규 active 공고가 있어도 fit, 회사 업사이드, 전환 가치가 낮으면 추천 티어에 억지로 넣지 않는다.
