...
- Discord 미리보기에는 강력 추천 최대 3개, 도전 추천 최대 2개를 기본으로 포함하되, 사용자가 넓은 preview 또는 전체 후보를 요청하면 `--postings data/runtime/live-position-postings.md --limit all`로 전체 active/open 후보를 보여준다.
...
- AI 모델 연구 중심 포지션과 CTO/기술총괄 포지션은 preview에서 제외한다.
