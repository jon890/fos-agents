...
| 5 | 지원 전략 작성 | 승부처, 지원동기, 기여 시나리오와 공백 보완 계획 | [지원 준비 품질 기준](references/application-quality-rubric.md) |
| 6 | 사용자 검토 | 동기, 역할 구분, 핵심 사례, 공백과 기여 시나리오의 사용자 확인 | [지원 문서 전수 검토](references/full-document-review.md) |
| 7 | 제출 문서 연결 | `resume-preparer` 호출과 준비 상태 | [이력서 제출 준비](../resume-preparer/SKILL.md) |
