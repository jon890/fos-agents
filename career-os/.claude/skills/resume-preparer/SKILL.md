...
[`flow.md`의 「비공개 작업 파일의 목표 흐름」](../../../docs/flow.md#비공개-작업-파일의-목표-흐름)을 `SKILL_NAME=resume-preparer`로 적용한다.
...
- 각 프로젝트에 해결한 문제, 그 문제가 왜 중요했는지, 당시 제약이 모두 있는가?
- 그 프로젝트의 핵심이 아닌 사례를 수치가 있다는 이유로 앞에 세우지 않았는가?
