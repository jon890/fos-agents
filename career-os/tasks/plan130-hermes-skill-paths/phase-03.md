...
4. 변경한 명령을 `career-os/.claude/skills/study-topic-recommender/references/source-management.md`에 적는다.
...
수정 파일은 `career-os/scripts/study-topic-recommender/manage_reading_sources.ts`, 같은 디렉터리의 `manage_reading_sources.test.ts`, `career-os/scripts/lib/cli-contract.test.ts`, `career-os/.claude/skills/study-topic-recommender/references/source-management.md`다.
...
"$HOME/.claude/skills/korean-check/scripts/check.sh" career-os/.claude/skills/study-topic-recommender/references/source-management.md
```
