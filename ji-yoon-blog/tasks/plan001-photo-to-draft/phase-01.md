...
**근거 문서**: `ji-yoon-blog/docs/data-schema.md` 의 사진 저장소 절, `ji-yoon-blog/docs/code-architecture.md` 의 실행 경계 절. 홈서버 공통 연결 계약은 저장소 루트의 `home-server-object-storage.md` 가 소유한다
